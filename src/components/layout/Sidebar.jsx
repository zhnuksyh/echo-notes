...
const Sidebar = ({
    ...
    return (
        <div className={`
        fixed inset-0 z-20 bg-neutral-900 border-r border-neutral-800 transition-all duration-300 ease-in-out flex flex-col
        ${isSidebarOpen
                ? 'translate-x-0 md:w-80 md:translate-x-0 md:relative'
                : '-translate-x-full md:w-0 md:translate-x-0 md:border-none overflow-hidden'}
      `}>
            {/* Sidebar Header */}
                    ...
                    filteredNotes.map(note => {
                        ...
                        return (
                            <div
                                ...
                                className={`
                      group relative p-3 mx-2 rounded-lg cursor-pointer transition-all hover:bg-neutral-800/50 mb-1
