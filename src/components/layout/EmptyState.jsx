...
const EmptyState = ({ onCreate }) => (
    <div className="h-full flex flex-col items-center justify-center text-neutral-500 p-8 text-center animate-fade-in font-poppins">
        ...
        <h2 className="text-xl font-semibold text-neutral-200 mb-2">Select a note to view</h2>
        <p className="max-w-xs mb-8 text-neutral-400">Choose a note from the sidebar or create a new one to get started.</p>
        <Button onClick={onCreate} icon={Plus}>Create New Note</Button>
    </div>
);
